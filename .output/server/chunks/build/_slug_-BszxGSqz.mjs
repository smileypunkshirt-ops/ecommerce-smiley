...
import { u as useRoute, s as storeToRefs, a as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a = unref(product)) == null ? void 0 : _a.image) {
...
//# sourceMappingURL=_slug_-BszxGSqz.mjs.map
